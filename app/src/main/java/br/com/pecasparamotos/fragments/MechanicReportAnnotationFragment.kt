 ...
 * [MechanicReportAnnotationFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [MechanicReportAnnotationFragment.newInstance] factory method to
 * create an instance of this fragment.
 *
 */
class MechanicReportAnnotationFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        val rootView = inflater.inflate(R.layout.fragment_mechanic_report_annotation, container, false)
    ...
    fun getAnnotations(): String {
        return etAnnotations!!.getText().toString()
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment MechanicReportAnnotationFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance() =
            MechanicReportAnnotationFragment().apply {
